...
import { addNewsletter, getNewsletter } from "../Store/ActionCreaters/NewsletterActionCreators"
                ...
                <div className="container py-1">
                    <div className="row">
                        <div className="col-md-6">
                            <h1 className='text-light'><Link to="/" className='text-light'>E-com</Link></h1>
                    ...
                    <div className="row g-5">
                        <div className="col-md-4">
                            ...
                            <Link className="btn btn-link text-light" to="/about">About</Link>
                            <Link className="btn btn-link text-light" to="/shop">Shop</Link>
                            <Link className="btn btn-link text-light" to="/contact-us">ContactUs</Link>
                        </div>
                        <div className="col-md-4">
                            <h5 className="text-white mb-4">Policies</h5>
                            <Link className="btn btn-link text-light" to="#">Privacy Policy</Link>
                            <Link className="btn btn-link text-light" to="#">Terms & Conditions</Link>
                            <Link className="btn btn-link text-light" to="#">Refund Policy</Link>
                            <Link className="btn btn-link text-light" to="#">FAQ</Link>
                        </div>
                        <div className="col-md-4">
                            <h5 className="text-white mb-4">Address</h5>
                            <p className="mb-2"><i className="fa fa-map-marker me-3"></i>A-43, Noida Sector 16</p>
                            <p className="mb-2"><i className="fa fa-envelope me-3"></i><a href="mailto:arnavroy688@gmail.com" target='_blank' rel="noreferrer" className='text-light'>arnavroy688@gmail.com</a></p>
                            <p className="mb-2"><i className="fa fa-phone me-3"></i><a href="tel:7368055121" className='text-light' target='_blank' rel="noreferrer">+91-7368055121</a></p>
