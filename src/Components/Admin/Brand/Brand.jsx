...
import { deletebrand, getbrand } from '../../../../src/Store/ActionCreaters/BrandActionCreater'
  ...
  const columns = [
...

    {
      ...
      renderCell:({row})=><a href={`/brands/${row.pic}`} target='_blank' rel='noreferrer'>
        <img src={`/brands/${row.pic}`} height={50} width={50} alt='#'/>
      </a>
    },
    ...
    <>
      ...
      <div className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-9'>
            <h5 className='bg-primary text-light text-center p-2'><span className='text-warning'>B</span>rand<Link to="/admin/brand/create" className='float-end text-light'><i className='fa fa-plus text-warning'></i></Link></h5>
